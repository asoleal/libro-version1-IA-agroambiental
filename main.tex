...
% --- Cajas para Aplicaciones Multidisciplinarias ---
...
\include{estructura-datos.tex}

\include{operaciones-estructuras}
\include{matrices-especiales}
\end{document}