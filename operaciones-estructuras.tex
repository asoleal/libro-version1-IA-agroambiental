...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/suma_vectores}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/escalar_vector}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/producto_punto}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/producto_punto_cos}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{imagenes/producto_matriz_vector}
